...
\newcommand{\valA}{1.990,00}
\newcommand{\valB}{2.790,00}
% saldo após abater a PoC e parcelas 50/50 (manter coerente com os totais acima)
\newcommand{\valAsaldo}{1.600,00}
\newcommand{\valBsaldo}{2.400,00}
\newcommand{\valAparc}{800,00}
\newcommand{\valBparc}{1.200,00}
  ...
  \begin{tikzpicture}
    \node[fill=white, fill opacity=0.07, text opacity=1, draw=gold, line width=1pt,
      ...
      \begin{minipage}{82mm}\centering
        ...
        {\small\color{white!75} contato@blumenauti.com.br \;\textbullet\; +55 47 98867-7798}
      \end{minipage}};
  \end{tikzpicture}
...
\begin{minipage}[t]{0.47\textwidth}
  ...
  \textbf{Blumenau\,\textcolor{golddk}{TI}}\\[1mm]
  {\small CNPJ 53.700.754/0001-10}\\[3mm]
